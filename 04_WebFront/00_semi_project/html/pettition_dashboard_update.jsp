...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="/00_semi_project/css/login__pettition_supporter_update.css">
...
<body>
                ...
                <div class="contentbox" id="dashboardUpdateContainer">
                    ...
                    <div>
                        ...
                        <div id="dashboardUpdateAddImage">
                            <div>
                                <img src="/00_semi_project/images/user.png" alt="">
                            </div>
                            <div>
                            ...
                            <div class="modal-window">
                                ...
                                <div class="modal-content-container">
                                    ...
                                    <div class="modal-content-title-profile">
                                        <img src="/00_semi_project/images/user.png" alt="user">
                                        <div>
                                            <p>사용자이름</p>
                                            <p>to 나에게</p>
                                        </div>  
    ...
    <script src="/00_semi_project/js/login__pettition_supporter_update.js"></script>
