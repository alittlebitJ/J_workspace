...
<head>
    ...
    <link rel="stylesheet" href="/04_WebFront/00_semi_project/css/myPettitions.css">
    <link rel="stylesheet" href="/04_WebFront/00_semi_project/css/login_mypettitions.css">
...
<body>
            ...
            <div class="userProfileframe contentBox"> <!-- 화면 크기와 상관없이 가운데에 위치하는 -->
                <div class="row"> <!-- 사용자 프로필 영역 -->
                    <div class="EditProfileText">
                        ...
                        <a href="/00_semi_project/html/login_editProfile.html">Edit profile</a> <!-- '프로필 편집'으로 넘어가는 버튼 -->
                    </div>
                </div>
    ...
    <script src="/04_WebFront/00_semi_project/js/login_mypettitions.js">
    </script>
</body>
</html>