...
// Servlet 관련 코드를 작성하기 위해서는 HttpServlet 클래스를 상속 받아야(tomcat에서 제공)
...
//		super.doGet(req, resp); <- 꼭 지워 줘야 함
//		요청 시 전달 된 input 태그의 값(parameter)을 얻어와 저장
//		** HTML에 작성된 모든 값은 String **
		
//		HttpServletRequest : 요청 데이터를 담고 있느 ㄴ객체
		String orderer = req.getParameter("orderer");
		String coffee= req.getParameter("coffee");
		String type = req.getParameter("type");
//		** name 속성 값이 같은 파라미터가 여러 개인 경우 : String[]로 한 번에 반환 받는 getParameterValues() 사용
...
//		응답용 스트림(서버 -> 클라이언트) 얻어오기
		...
		out.println("<body>");
			...
			if(type.equals("HOT")) 				out.println("따뜻한");
