...
<%-- JSTL 사용하려면 꼭 작성 필요 --%>
<%-- core : 제일 많이 사용하는 코드가 모여 있음(if, choose, forEach) --%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%-- function : 문자열 관련 기능, 배열/리스트 관련 기능이 모여 있음 --%>
...
<body>
    ...
    <pre>
      ...
      6) varStatus : 현재 반복 상태와 관련된 정보를 제공하는 변수 선언 (객체)
         varStatus="변수명"
