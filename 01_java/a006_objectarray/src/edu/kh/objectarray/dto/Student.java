...
public class Student {
	...
	// setter
	// public 반환형 set필드명(){}
	public void setGrade(int grade) { // 반환할 값이 없음. 셋팅하면 끝 그래서 return값 없이 void
		this.grade = grade;}
	...
	public String toString() {
		return String.format("%d학년 %d반 %d번 %s [%d, %d, %d]", grade, classRoom, number, name, kor, eng, math); // 자바에서 String은 class임, format은 printf같은 기능
	}
