...
-- 2. 회원 목록 조회(아이디, 이름, 성벌(남/여) + 회원 번호 내림차순)
...
UPDATE "MEMBER"
SET MEMBER_PW = 'pass04'
WHERE MEMBER_PW = 'pass05' AND MEMBER_NO = 4
;
...
UPDATE "MEMBER"
SET UNREGISTER_FL = 'N'
WHERE MEMBER_NO = 4 AND MEMBER_PW = 'pass05'
;
...
-- readcount 조회수 증가
UPDATE "BOARD"
SET READ_COUNT = READ_COUNT + 1		-- 이전 조회수 +1 값으로 수정 (수정할 때에만 '='은 대입 연산자가 됨)
WHERE BOARD_NO = ?
;
...
UPDATE  "BOARD"
SET BOARD_TITLE = '수정 제목 입니다',
	BOARD_CONTENT = '가나닫라마바사'
WHERE BOARD_NO = 1
;
...
INSERT INTO "COMMENT"
VALUES (SEQ_COMMENT_NO.NEXTVAL, '테스트댓글댓글', DEFAULT, DEFAULT, 4, 1)
;
...
FROM "COMMENT" 
WHERE COMMENT_NO = 1 AND DELETE_FL = 'N'
;
