...
-- 3.
SELECT PROFESSOR_NAME 교수이름, FLOOR(MONTHS_BETWEEN(SYSDATE, TO_DATE(SUBSTR(PROFESSOR_SSN, 1, 6), 'YYMMDD') - 365*100) / 12) 나이
FROM TB_PROFESSOR 
...
-- 7.
SELECT 
TO_CHAR(TO_DATE('99/10/11', 'YY/MM/DD'), 'YY"년"MM"월"DD"일"')
, TO_CHAR(TO_DATE('49/10/11', 'YY/MM/DD'), 'YY"년"MM"월"DD"일"')
, TO_CHAR(TO_DATE('99/10/11', 'RR/MM/DD'), 'RR"년"MM"월"DD"일"')
, TO_CHAR(TO_DATE('49/10/11', 'RR/MM/DD'), 'RR"년"MM"월"DD"일"')
FROM DUAL;
