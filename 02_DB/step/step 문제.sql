...
INSERT INTO "BOARD"
VALUES (SEQ_BOARD_NO.NEXTVAL, '첫 글', '스탭평가', 100, SYSDATE);

INSERT INTO "BOARD"
VALUES (SEQ_BOARD_NO.NEXTVAL, '두 번째 글', '재밌다', 300, SYSDATE);

INSERT INTO "BOARD"
VALUES (SEQ_BOARD_NO.NEXTVAL, '세 번째 글', '하하하', 200, SYSDATE);


-- 5
SELECT BOARD_NO 글번호, BOARD_TITLE 글제목, BOARD_CONTENT 글내용, BOARD_WRITER 작성자번호, TO_CHAR(CREATE_DATE, 'YYYY-MM-DD') 작성일자
FROM BOARD ;
